...
function continueSearch() {
  ...
  let is_map = i.includes("google.") && i.includes("/maps/"),
      ...
      is_new = i.includes("google.") && (i.includes("tbm=nws") || i.includes("news.google.")),
      is_video = i.includes("google.") && (i.includes("tbm=vid") || i.includes("video.google.")),
  ...
  if (is_map) {
    let endElements = document.querySelectorAll('div[class="m6QErb tLjsW eKbjU "]');
    let contentElement = document.querySelectorAll('div[class="m6QErb DxyBCb kA9KIf dS8AEf ecceSd QjC7t"]')[0];
    if (!endElements) {
